              ...
              <div class="card card-registration card-registration-2" style="border-radius: 15px;">
                <div class="card-body p-0">
                  <div class="row g-0">
                    <div class="col-lg-6">
                      <div class="p-5">
                        <h3 class="fw-normal mb-5" style="color:#fa9805;">covid-19 vaccination mgt sys reg form</h3>
      
                        <div class="mb-4 pb-2">
                          <select class="select">
                            <option value="1">covid registration</option>
                            <option value="2">phase 1</option>
                        ...
                        <div class="mb-4 pb-2">
                          <select class="select">
                            ...
                            <option value="2">fever or chills</option>
                            <option value="3">body aches</option>
                            <option value="4">vomiting</option>
                            <option value="5">sore throat</option>
                            <option value="5">caugh</option>
                          </select>
                        </div>
                        ...
                        <div class="mb-4 pb-2">
                          <div class="form-outline">
                            ...
                            <label class="form-label" for="form3Examplev4">symptoms</label>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                            ...
                            <div class="form-outline">
                              ...
                              <label class="form-label" for="form3Examplev5"> vaccine type</label>
                            </div>
                          ...
                          <div class="col-md-6">
                            ...
                            <select class="select">
                              ...
                              <option value="3">covishield</option>
                              <option value="4">sputnik-v</option>
                              <option value="5">child vaccine</option>
                            </select>
                    ...
                    <div class="col-lg-6 bg-indigo text-white">
                      <div class="p-5">
                        ...
                        <a  href="https://www.cowin.gov.in/"type="button" class="btn btn-light btn-lg"
